...
var DBoxExpress = function(token, opt) {
  opt = opt || DBoxExpress.default;
...
DBoxExpress.prototype.getDirectLink = function(path, fn) {
...
DBoxExpress.prototype.redirect = function(pattern) {
  var self = this
...
DBoxExpress.obtaintoken = function() {
...
if(require.main === module)
  DBoxExpress.obtaintoken()
else module.exports = DBoxExpress;
